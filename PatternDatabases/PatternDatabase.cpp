...
size_t PatternDatabase::getSize() const { return this->size; }

size_t PatternDatabase::getNumItems() const { return this->numItems; }

bool PatternDatabase::isFull() const { return this->numItems == this->size; }
...
bool PatternDatabase::fromFile(const string &filePath) {
  ...
  if (!reader.is_open()) {
    throw "Failed to open the file to read";
  }
