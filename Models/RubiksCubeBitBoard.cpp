...
class RubiksCubeBitBoard : public RubiksCube {
 private:
  ...
  void rotateSide(int s1, int s1_1, int s1_2, int s1_3, int s2, int s2_1,
                  int s2_2, int s2_3) {
    ...
    bitboard[s1] =
        (bitboard[s1] & ~(one_8 << (8 * s1_1))) | (clr1 << (8 * s1_1));
    bitboard[s1] =
        (bitboard[s1] & ~(one_8 << (8 * s1_2))) | (clr2 << (8 * s1_2));
    bitboard[s1] =
        (bitboard[s1] & ~(one_8 << (8 * s1_3))) | (clr3 << (8 * s1_3));
  }
 ...
 public:
  ...
  RubiksCube &u() override {
    ...
    bitboard[4] = (bitboard[4] & ~one_24) | (bitboard[5] & one_24);
    bitboard[5] = (bitboard[5] & ~one_24) | temp;
